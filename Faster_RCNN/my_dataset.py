...
"""
  @Time    : 2024.01.03 09:01
  @File    : my_dataset.py
  @Project : Object_Det
  @Author  : Saitama
  @IDE     : PyCharm
  @Desc    : 解析PascalVOC 2012数据集
"""
import json
import os.path
...
class PascalVocDataset(Dataset):
    ...
    def __init__(self, voc_root, transforms, train_set=True):
        ...
        # 读取txt文件
        with open(txt_list, "r") as rf:
            self.xml_list = [os.path.join(self.annotations_root, line.strip(), ".xml") for line in rf.readlines()]
